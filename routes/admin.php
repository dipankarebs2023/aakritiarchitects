...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::get('/dynamic-menu', [MenuController::class, 'dymenu'])->name('settings.dynamic-menu');
    Route::post("/addmenu",[MenuController::class,"create"]);
    
    Route::get('/slider', [SliderController::class, 'sliderPage'])->name('settings.slider');
    Route::post("/addslider_image",[SliderController::class,"create"]);
    Route::get("/show_slider/{id}",[SliderController::class,"sliderShow"]);
    Route::get("/slider/delete/{id}",[SliderController::class,"deleteSlider"]);
    Route::post("show_slider/update_slider_image",[SliderController::class,"UploadSlider"]);

    Route::get('/popup', [PopupController::class, 'popupPage'])->name('settings.popup');
